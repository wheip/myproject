...
void UESTCQCustomPlot::updateRealTimeLines(QVector<QCPGraph*> graphs, QVector<QList<double>> data)
{
    ...
    for (int i = 0; i < graphs.size(); ++i) {
        ...
        // 清空数据前先隐藏该图的游标，防止更新过程中触发 QCPItemTracer::updatePosition
